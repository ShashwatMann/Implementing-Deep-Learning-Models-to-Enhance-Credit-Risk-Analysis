...
hidden_neurons = 128
fullyConnected_layer1 = FullyConnectedLayer(X_train.shape[1], hidden_neurons, initialization='xavier', optimizer='adam')
ReLu_Layer = ReLuLayer()
fullyConnected_layer2 = FullyConnectedLayer(hidden_neurons, 1, initialization='xavier', optimizer='adam')
sigmoid_layer = LogisticSigmoidLayer()

log_loss = LogLoss()
network = [fullyConnected_layer1, ReLu_Layer, fullyConnected_layer2, sigmoid_layer, log_loss]

epochs = 10000  # Fixed number of epochs
train_losses = []
val_losses = []
